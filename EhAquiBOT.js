...
(function () {
    ...
    var basicBot = {
        ...
        commands: {
            ...
            cookieCommand: {
                command: ['biscoito', 'cookie'],
                rank: 'user',
                type: 'startsWith',
                cookies: ['has given you a chocolate chip cookie!',
                    'te deu um biscoito macio de aveia caseiro!',
                    'te deu um biscoito liso, seco e velho. Era o último da bolsa. Nojento.',
                    'te dá um biscoito de açúcar. O que? Sem flocos? Se eu fosse você não aceitava...',
                    'te dá um biscoito de chocolate. Mas espera, são passas. Urgh!',
                    'te dá um biscoito enorme! Se cutucar ele te dá mais cookies :P',
                    'te dá um biscoito da sorte. Ele diz: "Por que você não está trabalhando em algum projeto?"',
                    'te dá um biscoito da sorte. Ele diz: "Dá aquela pessoa especial um elogio."',
                    'te dá um biscoito da sorte. Ele diz: "Corra o risco!"',
                    'te dá um biscoito da sorte. Ele diz: "Vai pra fora."',
                    'te dá um biscoito da sorte. Ele diz: "Não se esqueça de comer os vegetais."',
                    'te dá um biscoito da sorte. Ele diz: "..."',
                    'te dá um biscoito da sorte. Ele diz: "m808 pls"',
                    'te dá um biscoito da sorte. Ele diz: "Se você se virar, vai ver as moças bonitas."',
                    'te dá um biscoito da sorte. Ele diz: "Eu te amo."',
                    'te dá um biscoito de ouro. Você não pode comer porque é feito de ouro. Droga.',
                    'te dá um biscoito Oreo com um copo de leite.',
                    'te dá um biscoito de arco-íris feito com amor <3',
                    'te dá um biscoito velho, que foi deixado na chuva. É mofado.',
